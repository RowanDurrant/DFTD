...
circularHead<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_circular_head")
waratahWynyard<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_waratah_wynyard")
westCoast<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_west_coast")
centralCoast<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_central_coast")
burnie<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_burnie")
devonport<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_devonport")
kentish<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_kentish")
latrobe<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_latrobe")
georgeTown<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_george_town")
westTamar<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_west_tamar")
dorset<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_dorset")
launceston<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_launceston")
northernMidlands<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_northern_midlands")
meanderValley<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_meander_valley")
breakODay<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_break_o_day")
huonValley<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_huon_valley")
derwentValley<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_derwent_valley")
centralHighlands<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_central_highlands")
glamorganSpringBay<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_glamorgan_spring_bay")
southernMidlands<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_southern_midlands")
clarence<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_clarence")
brighton<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_brighton")
glenorchy<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_glenorchy")
kingborough<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_kingborough")
sorell<-readOGR(dsn=path.expand("C:/Users/User/Desktop/Land use data"),layer="list_tasveg_20_sorell")
...
tiff("figure_1a.tif", width=6*dpi, height=5*dpi, res=dpi)
...
write.csv(networkDF, file = "dry_wet_networktopology.csv")
