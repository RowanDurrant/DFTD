...
# Parameters --------------------------------------------------------------
patchData = read.csv(file = "data/dry_wet_patch areas.csv")
...
RunModel = function(TumGrRate, DispDist, A, B, BP, K, MaxAge, patchDims, Sex, startpop, Time, g, R, Z){
  ...
  save(agelist, sexlist, poplist, inflist, indslist, diverselist, NData2, file=paste0("Degree_rep_",R,"_step_",Z,".rda"))
